...
class Menu(Frame):
    ...
    def build_options_list(self):
        # Options
        options = Label(self, text="Options : ")
        options.configure(font=font.Font(family=Menu.FONT_MAIN, size=12))
        options.configure(background=Menu.COLOR_BG, foreground=Menu.COLOR_FG)
        options.grid(sticky=W, padx=5)
